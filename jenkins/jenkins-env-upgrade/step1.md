1\. The command used to launch the container was:
...
2\. The environment has a Jenkins server running as a Docker Container. You can view the status using `docker ps`{{execute}}.
